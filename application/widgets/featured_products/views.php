<div class="gallery gallery-product wow fadeInUp animated" data-wow-delay=".7s">
    <div class="container">
        <div class='title-product'>
            ...
            <div style ='padding: 0px;' class="col-lg-3 col-sm-3 col-xs-4">
                ...
                <div class="controls pull-right hidden-xs">
                    <a class="left glyphicon glyphicon-menu-left btn btn-danger" href="#carousel-example"
                       data-slide="prev"></a>
                    <a class="right glyphicon glyphicon-menu-right btn btn-danger" href="#carousel-example"
                       data-slide="next"></a>
                </div>
        ...
        <?php
            ...
            {
                ?>
                    <div id="carousel-example" class="carousel carousel-gb slide hidden-xs">
                        <!-- Wrapper for slides -->
                            ...
                            <div class="item active">
                                <?php
                                    foreach ($posts as $key => $post)
                                    {
                                        ...
                                        {
                                            ?>
                                                <div class="product-featured-gb col-sm-3">
                                                <div class="col-item">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                foreach ($posts as $key => $post)
                                {
                                    ...
                                    {
                                        ?>
                                        <div class="product-featured-gb col-lg-6 col-sm-6 col-xs-6">
                                            <div class="col-item">
                                                <div class="photo photo-product">
                                                    <a href="/sp/<?=$post['alias']?>.html"> <img src="<?=$post['thumb']?>" class="img-responsive" alt="<?=$post['name']?>" /></a>
                                                </div>
