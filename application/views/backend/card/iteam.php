                        ...
                        <div class="table-responsive">
                            <table class="table table-striped jambo_table bulk_action">
                                ...
                                <tr class="headings">
                                    ...
                                    <th class="column-title">Seri</th>
                                    <th class="column-title">Before </th>
                                    <th class="column-title">After </th>
                                    <th class="column-title">Denominations </th>
                                    ...
                                    foreach ($cards as $post)
                                    {
                                        ...
                                        if ($i % 2 == 0)
                                        {
                                            ...
                                            <tr id="id-<?=$post['id']?>" class="odd pointer">
                                                ...
                                                <td>
                                                    <p><?=isset($post['code'])?$post['code']:''?></p>
                                                    <a style=" color: #00CC00">Username : <?=$post['use_admin']['username']?></a>
                                                </td>
                                                <td class=" ">
                                                    <p><?=isset($post['seri'])?$post['seri']:''?></p>
                                                </td>
                                                <td class="">
                                                    <?=isset($post['before'])?number_format($post['before']):''?>
                                                </td>
                                                <td class=" ">
                                                    <?=isset($post['after'])?number_format($post['after']):''?>
                                                </td>
                                                <td class=" ">
                                                    <?=isset($post['denominations'])?number_format($post['denominations']):''?>
                                                </td>
                                                <td class=" ">
...
<script type="text/javascript">
    ...
    function remove(id) {
        if (id)
        {
            ...
            if (result)
            {
                $.post("<?=URL?>/manager/ajax-card/delete", {id:id},
                    function(data)
                    {
                        $("#id-"+id).hide();
